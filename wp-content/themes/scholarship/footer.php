			...
			<div class="site-info">
				<div class="mt-container">
					...
					<div class="scholarship-copyright-wrapper">
						...
						<span class="sep"> </span>
						<?php printf( esc_html__( '%1$s Customized by %2$s.', 'scholarship' ), ' Theme', '<a href="'. esc_url( 'https://www.mahamudhasan23.com/' ).'" rel="designer" target="_blank">Mahamudul Hasan</a>' ); ?>
					</div>
